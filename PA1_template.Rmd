...
plot(timeseries_weekday,type="l",xlab="5-minute interval",ylab="steps",ylim=c(0,210))
text(0,200,"Weekday",pos=4)
plot(timeseries_weekend,type="l",xlab="5-minute interval",ylab="steps",ylim=c(0,210))
